...
JOBKOREA_COMPANIES = [
    ...
    # 3차 추가 (누락 채널 보강 2026-06-10)
    ("1547703", "컴투스홀딩스", "com2usholdings"),
    ("16154318", "위메이드맥스", "wemademax"),
    ("16152331", "위메이드플레이", "wemadeplay"),
    ("16152335", "스마일게이트RPG", "smilegaterpg"),
    ("16153723", "하이브IM", "hybeim"),
    ("16154089", "빅게임스튜디오", "vicgamestudios"),
]
